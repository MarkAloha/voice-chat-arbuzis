...
Простой веб-сервис для голосового общения в одной комнате. Пользователь заходит на сайт, вводит общий пароль и имя, попадает в комнату и общается голосом и текстом.

## Стабильная версия 2.0.0

**v2.0.0** — первая мажорная отсечка: полноценная комната с голосом, текстовым чатом, настройками и индикаторами качества связи. Версия проверена в production на VPS.
...
![Голосовая комната — участники, чат, управление](docs/screenshots/room.png)

### Что входит в 2.0.0

**Голос**

- WebRTC через LiveKit, одна общая комната (до 5 участников)
- Включение / выключение микрофона
- Шумоподавление DTLN (beta), настройка в боковой панели
- Регулировка громкости входящего звука — общая и по каждому участнику (наушники + ползунок)
- Подсветка говорящего участника
- Звуки интерфейса — микрофон вкл/выкл, вход участника (можно отключить)
- Автопереподключение после блокировки экрана и возврата на вкладку
- Wake Lock — экран не гаснет во время разговора

**Участники**

- Список с аватарами, цветами и уникальными именами
- Индикатор качества соединения (полоски сигнала) у каждого участника
- Приглашение по ссылке (копирование в буфер)
- Настройки комнаты — шумоподавление, звуки UI

**Чат**

- Текстовые сообщения между участниками
- Смайлики, удаление своих сообщений
- Поле ввода на всю ширину панели

**Интерфейс**

- Тёмная тема, русский язык
- Понятные сообщения об ошибках
- Страница `/roadmap` с планами развития
- Кнопка «Подключено» → «Отключиться» без сдвига вёрстки

Подробнее о будущих фичах: [ROADMAP.md](ROADMAP.md).
...
│   │   ├── pages/roadmap/  # Публичный roadmap
│   │   ├── services/       # LiveKit, API, сессия, звуки
...
4. Список участников и чат обновляются через события LiveKit Room.
